...
async function sendMessage() {
    ...
    var userMessage = document.getElementById("user-input").value; //Hämtar användarens meddelande
    ...
    var chatBox = document.getElementById("chat-box"); //Hämtar chat-boxen
    var userMessageElement = document.createElement("div"); //Skapar en div för användarens meddelande
    ...
    var botMessageElement = document.createElement("div"); //Skapar en div för botens meddelande
    ...
    var botResponse = await getCohereResponse(filteredUserMessage); //Hämtar botens svar
